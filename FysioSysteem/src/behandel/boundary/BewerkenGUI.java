 ...
 * @author Nigel
 */
public class BewerkenGUI extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BewerkenGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
